...
add_library(grevir_fastled_compile OBJECT native_compile.cpp ${header_sources})
target_link_libraries(grevir_fastled_compile PRIVATE grevir::fastled grevir::peripherals)
...
add_custom_target(grevir_fastled_claim_checks ALL
  ...
  COMMENT "Checking FastLED singleton and pin claims"
  VERBATIM)
